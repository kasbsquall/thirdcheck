...
const CONFIRMATIONS: Record<string, { verdict: Verdict; reason: string }> = {
  // VaultBridge — confirmed real. The fake selector is the actual verification path.
  "VaultBridge|contracts/src/creditcoin/VaultLending.sol:147": {
    verdict: "confirmed",
  ...
  "VaultBridge|contracts/src/creditcoin/interfaces/IUSCVerifier.sol:7": {
    verdict: "confirmed",
  ...
  "VaultBridge|contracts/src/creditcoin/interfaces/IUSCVerifier.sol:17": {
    verdict: "confirmed",
  ...
  "VaultBridge|contracts/src/creditcoin/MockStreakPrecompile.sol:10": {
    verdict: "confirmed",
  ...
  "FactorX|src/CommercialIntent.sol:37": { verdict: "noise", reason: "false positive: `verifier` is an authorized-submitter role gating recordIntent (data write), not a proof verifier" },
  "FactorX|src/ReceivableRegistry.sol:66": { verdict: "noise", reason: "false positive: `verifier` is an authorized-caller role (onlyVerifier gates a data write), not a proof verifier" },
